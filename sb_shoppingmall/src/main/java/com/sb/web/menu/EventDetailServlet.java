...
public class EventDetailServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int eventNo = CommonUtils.stringToInt(request.getParameter("no"), 1);
		...
		List<Product> products = listDao.getProductsByEvent(param);
		...
		int totalRows = listDao.getProductsByEventTotalRows(eventNo);
		// 전체페이지
