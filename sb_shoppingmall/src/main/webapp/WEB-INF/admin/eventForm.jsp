...
<body>
	<c:set var="menu" value="EVENTFORM"/>
	...
	<div class="container-fluid h-100">
		...
		<%@include file="/WEB-INF/common/adminAside.jsp" %>
			<div class="col-10 h-100 side-content">
				...
				<h3 class="pt-4 pl-4">기획전 등록</h3>
				
				<div class="row justify-content-center mt-5">
					<div class="col-10">
						<!--폼시작  -->
						<form action="/sb/adminEventForm" method="post" enctype="multipart/form-data">
							<div class="form-group">
							    <label>기획전 제목</label>
							    <input type="text" class="form-control" placeholder="Enter Title" id="event-title" name="title" required/>
							</div>
							<div class="form-group">
							    <label>기획전 내용</label>
							    <input type="text" class="form-control" placeholder="Enter Content" id="event-title" name="content" required/>
							</div>
							<div class="form-group">
							    <label>기획전 시작일</label>
							    <input type="datetime-local" class="form-control" id="start-date" name="startDate" onchange="checkDate()"/>
							</div>
							<div class="form-group">
							    <label>기획전 종료일</label>
							    <input type="datetime-local" class="form-control" id="end-date" name="endDate" required onchange="checkDate()"/>
							</div>
							<div class="form-group">
							    <label>기획전 썸네일<span style="font-size:12px;"> (권장사이즈 1000*300px / jpg, png, gif 파일만 업로드 하세요)</span></label>
							  	<div class="input-group mb-3">
<!-- 									<label class="input-group-text" for="inputGroupFile02">Upload</label>
 -->									<input type="file" class="form-control" id="event-thum" name="eventThum" accept="image/jpeg, image/png, image/gif" style="padding:3px;" required>
								</div>
							</div>
							<div class="form-group">
