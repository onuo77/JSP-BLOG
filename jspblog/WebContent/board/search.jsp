...
<div class="container">
	...
	<ul class="pagination justify-content-center">
		<c:choose>
			...
			<c:otherwise>
				<li class="page-item"><a class="page-link" href="/jspblog/board?cmd=search&keyword=${param.keyword }&page=${param.page-1 }">Prev</a></li>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			...
			<c:otherwise>
				<li class="page-item"><a class="page-link" href="/jspblog/board?cmd=search&keyword=${param.keyword }&page=${param.page+1 }">Next</a></li>
			</c:otherwise>
		</c:choose>
	</ul>
